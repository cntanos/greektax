...
This document is the canonical source for translation and localisation procedures.
...
6. When introducing a new locale, schedule a UI review to confirm layouts still
   accommodate translated copy. The Sprint 16 visual-polish checklist in
   [`docs/archive/ui_improvement_plan.md`](archive/ui_improvement_plan.md) is a
   useful reference for what "polished" means in this app.
...
- [`docs/archive/ui_improvement_plan.md`](archive/ui_improvement_plan.md) –
  archived Sprint 16 visual-polish checklist; useful as a "what good looks
  like" reference when translated copy or locale toggles evolve.
