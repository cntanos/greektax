  ...
  const translations = {
    "el": {
      ...
      "fields": {
        ...
        "tax-residency-transfer": "Μεταφορά φορολογικής έδρας στην Ελλάδα",
      ...
      "status": {
        ...
        "chart_library_unavailable": "Τα γραφήματα δεν είναι προσωρινά διαθέσιμα επειδή δεν φορτώθηκε η βιβλιοθήκη οπτικοποίησης.",
    ...
    "en": {
      ...
      "fields": {
        ...
        "tax-residency-transfer": "Tax residency transfer to Greece",
      ...
      "status": {
        ...
        "chart_library_unavailable": "Charts are temporarily unavailable because the visualisation library could not be loaded.",
