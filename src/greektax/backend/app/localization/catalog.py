...
_MESSAGES: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "share.title": "GreekTax summary",
        "share.heading": "Tax summary",
        "share.summary_heading": "Overview",
        "share.detail_heading": "Detailed breakdown",
        "share.generated_with": "Generated with the unofficial GreekTax calculator.",
        "share.detail_fields.gross_income": "Gross income",
        "share.detail_fields.deductible_contributions": "Mandatory contributions",
        "share.detail_fields.deductible_expenses": "Deductible expenses",
        "share.detail_fields.taxable_income": "Taxable income",
        "share.detail_fields.tax_before_credits": "Tax before credits",
        "share.detail_fields.credits": "Credits",
        "share.detail_fields.tax": "Tax",
        "share.detail_fields.trade_fee": "Business activity fee",
        "share.detail_fields.total_tax": "Total tax",
        "share.detail_fields.net_income": "Net impact",
        "share.detail_fields.breakdown": "Breakdown",
    },
    "el": {
        ...
        "share.title": "Σύνοψη GreekTax",
        "share.heading": "Σύνοψη φόρων",
        "share.summary_heading": "Επισκόπηση",
        "share.detail_heading": "Αναλυτική παρουσίαση",
        "share.generated_with": "Παραγόμενο με το ανεπίσημο εργαλείο GreekTax.",
        "share.detail_fields.gross_income": "Ακαθάριστο εισόδημα",
        "share.detail_fields.deductible_contributions": "Υποχρεωτικές εισφορές",
        "share.detail_fields.deductible_expenses": "Εκπιπτόμενες δαπάνες",
        "share.detail_fields.taxable_income": "Φορολογητέο εισόδημα",
        "share.detail_fields.tax_before_credits": "Φόρος πριν τις εκπτώσεις",
        "share.detail_fields.credits": "Εκπτώσεις",
        "share.detail_fields.tax": "Φόρος",
        "share.detail_fields.trade_fee": "Τέλος επιτηδεύματος",
        "share.detail_fields.total_tax": "Συνολικός φόρος",
        "share.detail_fields.net_income": "Καθαρή επίδραση",
        "share.detail_fields.breakdown": "Ανάλυση",
    },
}
